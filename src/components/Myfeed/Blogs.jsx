        ...
        <div className="flex flex-row items-center justify-start gap-3">
          <a href={profileUrl}>
            <div className="relative flex h-10 w-10 cursor-pointer items-center justify-center overflow-hidden rounded-full bg-slate-100">
              <img alt="Profile" className="avatar" src={profileImage} loading="lazy" />
            </div>
          </a>
...
export default function Blogs() {
  ...
  const posts = [
    {
      profileUrl: "https://darshit-dev.vercel.app/",
      profileImage:
        "https://darshit-dev.vercel.app/profile.png",
      profileName: "Darshit Sojitra",
      postUrl:
